...
frag_per_gene_collected <- read.table("collected fragment lengths per gene.txt", header = T)
nmf_genes_lengths(frag_per_gene_collected,enrichment_df,"NAC.1")
nmf_genes_lengths(frag_per_gene_collected,enrichment_df,"NAC.2")
nmf_genes_lengths(frag_per_gene_collected,enrichment_df,"NAC.3")
nmf_genes_lengths(frag_per_gene_collected,enrichment_df,"NAC.4")
nmf_genes_lengths(frag_per_gene_collected,enrichment_df,"NSC.1")
nmf_genes_lengths(frag_per_gene_collected,enrichment_df,"NSC.2")
nmf_genes_lengths(frag_per_gene_collected,enrichment_df,"NSC.3")
nmf_genes_lengths(frag_per_gene_collected,enrichment_df,"NSC.4")
nmf_genes_lengths(frag_per_gene_collected,enrichment_df,"SSC.1")
nmf_genes_lengths(frag_per_gene_collected,enrichment_df,"SSC.2")
nmf_genes_lengths(frag_per_gene_collected,enrichment_df,"SSC.3")
nmf_genes_lengths(frag_per_gene_collected,enrichment_df,"SSC.4")